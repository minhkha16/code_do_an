<header class="relative bg-white dark:bg-darker">
    <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
        ...
        <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
            ...
            {{-- <div><ul><li>{{auth()->user()->name}}</li></ul></div> --}}
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                >
                    ...
                    <img class="w-10 h-10 rounded-full" src="{{asset('assets/build/images/avatar.jpg')}}" alt="Ahmed Kamel" />
                </button>
                ...
                >
                    <a href="{{route('logout_admin')}}" role="menuitem" class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-primary">
                        Logout
                    </a>
                </div>
            </div>
        ...
        <nav aria-label="Main" class="px-2 py-4 space-y-2">
            ...
            <div x-data="{ isActive: false, open: false }">
                ...
                <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" arial-label="Pages">
                    <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                    <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                    <a href="{{asset('assets/pages/blank.html')}}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                        Blank
                    </a>
                    <a href="{{asset('assets/pages/404.html')}}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                        404
                    </a>
                    <a href="{{asset('assets/pages/500.html')}}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                        500
                    </a>
                    <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                        Profile (soon)
            ...
            <div x-data="{ isActive: false, open: false}">
                ...
                <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                    <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                    <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                    <a href="{{asset('assets/auth/register.html')}}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
                        Register
                    </a>
                    <a href="{{asset('assets/auth/login.html')}}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
                        Login
                    </a>
                    <a href="{{asset('assets/auth/forgot-password.html')}}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
                        Forgot Password
                    </a>
                    <a href="{{asset('assets/auth/reset-password.html')}}" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700">
                        Reset Password
                    </a>
                </div>
            </div>
            ...
            <div x-data="{ isActive: false, open: false}">
                ...
                <div x-show="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Layouts">
                    ...
                    <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                    <a
                        href="{{asset('assets/layouts/two-columns-sidebar.html')}}"
                        role="menuitem"
                    ...
                    <a
                        href="{{asset('assets/layouts/mini-plus-one-columns-sidebar.html')}}"
                        role="menuitem"
                        class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                    >
                    ...
                    <a
                        href="{{asset('assets/layouts/mini-column-sidebar.html')}}"
                        role="menuitem"
                        class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"
                    >
                        Mini Column Sidebar
